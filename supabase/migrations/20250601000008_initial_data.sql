...
-- 初期データを挿入するスクリプト
-- 作成日: 2025/6/1
-- 更新内容: システムの初期設定として必要なデータを挿入

-- 管理者ユーザーの作成（既に存在する場合は更新）
-- 注意: UUIDはユーザー固有のものを使用します
INSERT INTO public.users (id, email, full_name, is_admin)
VALUES 
  ('396c7505-4679-4440-8c95-a4c9fe62c2ca', 'admin@example.com', 'Administrator', true)
...
-- デフォルトのシンボル設定
INSERT INTO public.symbol_settings (user_id, symbol, is_favorite, display_order)
VALUES
...
-- デフォルトのチャート設定
INSERT INTO public.chart_settings (user_id, timeframe, chart_type)
VALUES
